...
import { validateStringByRegex } from './utils.js';
...
export default class FormView extends View {
	...
	_createFormFields() {
		...
		this.alignmentDropdown = this._createDropdown( t( 'Alignment' ), [
			{ icon: IconAlignLeft, text: t( 'left' ), className: 'ck ck-iframe-alignleft' },
			{ icon: IconAlignCenter, text: t( 'middle' ), className: 'ck ck-iframe-alignmiddle' },
			{ icon: IconAlignRight, text: t( 'right' ), className: 'ck ck-iframe-alignright' }
		...
		this.okButton = this._createButton( t( 'OK' ), IconCheck, 'ck-iframe-button-ok ck-button-save' );
		this.cancelButton = this._createButton( t( 'Cancel' ), IconCancel, 'ck-iframe-button-cancel ck-button-cancel' );
	}
